...
class ReleForm(forms.Form):
    ...
    checkbox4 = forms.BooleanField(label='Реле 4', required=False)
    ...
    checkbox10 = forms.BooleanField(label='Реле 10', required=False)
    ...
    checkbox16 = forms.BooleanField(label='Реле 16', required=False)
    ...
    checkbox22 = forms.BooleanField(label='Реле 22', required=False)
    ...
    checkbox28 = forms.BooleanField(label='Реле 28', required=False)
    ...
    checkbox34 = forms.BooleanField(label='Реле 34', required=False)
